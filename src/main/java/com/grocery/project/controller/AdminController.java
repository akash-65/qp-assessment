...
public class AdminController {
    ...
    @PostMapping("/items")
    public ResponseEntity<GroceryDTO> addItem(@Valid @RequestBody GroceryDTO groceryDTO) {
    ...
    public ResponseEntity<GroceryDTO> updateItem(@Valid @RequestBody GroceryDTO groceryDTO, @PathVariable Long groceryId) {
